...
function randNumber(options) {
  ...
  return fake(function () {
    return getRandomInRange(config);
  }, options);
}
...
function randBook(options) {
  var bookData = (options === null || options === void 0 ? void 0 : options.category) ? data$1O.filter(function (_a) {
...
function randCreditCardNumber(options) {
  ...
  var formats = data$1C.map(function (_a) {
    var formats = _a.formats;
    return formats;
  }).flat();

  if (options === null || options === void 0 ? void 0 : options.issuer) {
    formats = ((_a = data$1C.find(function (card) {
  ...
  var minNumb = 0;
  var maxNumb = 9;
  var cardsArray = Array.from({
    length: (options === null || options === void 0 ? void 0 : options.length) || 1
  }, function (_, index) {
    return rand(formats).replace(/#/g, function () {
...
function randFirstName(options) {
  ...
  var names = withAccents ? data$1m['withAccents'] : data$1m['withoutAccents'];
...
function randLastName(options) {
  ...
  var withAccents = (_a = options === null || options === void 0 ? void 0 : options.withAccents) !== null && _a !== void 0 ? _a : randBoolean();
  var names = withAccents ? data$1l['withAccents'] : data$1l['withoutAccents'];
  return fake(names, options);
}
...
function randGender(options) {
  return fake((options === null || options === void 0 ? void 0 : options.code) ? data$1d : data$1e, options);
}
...
function randPhoneNumber(options) {
  ...
  if (options === null || options === void 0 ? void 0 : options.countryCode) {
    formats = ((_a = data$Y.find(function (country) {
      return country.countryCode.includes(options.countryCode);
    })) === null || _a === void 0 ? void 0 : _a.formats) || [];
  } else {
    formats = data$Y.map(function (_a) {
      var formats = _a.formats;
      return formats;
    }).flat();
  }
...
function randProtocol(options) {
  return fake((options === null || options === void 0 ? void 0 : options.fullName) ? data$P : data$Q, options);
}
...
function randLanguage(options) {
  return fake((options === null || options === void 0 ? void 0 : options.code) ? data$s : data$t, options);
}
...
var _a$1;
var totalOrigins = (_a$1 = Object.keys(data$q)) === null || _a$1 === void 0 ? void 0 : _a$1.length;
/**
...
function randStatus(options) {
  ...
  if (options === null || options === void 0 ? void 0 : options.type) {
    var filteredStatuses = data$a.filter(function (status) {
    ...
    statuses = data$a.map(function (_a) {
      var status = _a.status;
      return status;
    }).flat();
  }
...
function randSuperhero(options) {
  var factory = function factory() {
    var heroes = (options === null || options === void 0 ? void 0 : options.company) ? data$6.filter(function (_a) {
      var company = _a.company;
      return company === options.company;
    }) : data$6;
    return __assign(__assign({}, rand(heroes)), {
      id: randUuid()
    });
  };
...
var _a;
var categoriesCount = (_a = Object.keys(data$5)) === null || _a === void 0 ? void 0 : _a.length;
/**
...
exports.randCreditCardIssuer = randCreditCardIssuer;
